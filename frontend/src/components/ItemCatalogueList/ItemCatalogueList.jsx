        ...
        {movies && movies.map((movie) => (
          <>
            <div className="relative" key={movie.id}>
              {movie.movie_id && <button onClick={() => {removeFromList(movie._id)}}  type="button" className="absolute top-0 right-0 z-10 border-0 text-white bg-red-700 hover:bg-red-800 text-sm sm:w-auto px-6 py-2.5 text-center">Del</button>}       
